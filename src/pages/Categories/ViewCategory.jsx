...
import { subCategoriesFormFields } from "../../seed/form-fields";
...
function ViewCategory({ open, handleClose, selected }) {
    ...
    const values = [
        {
            ...
            event_category_id: selected.id,
            event_sub_category_name: action === UPDATE ? selectedData.event_sub_category_name : "",
            ...
            <DialogContent>
                ...
                {openCreateDialog && (
                    <FormDialog
                        ...
                        action={action}
                        fields={subCategoriesFormFields}
                        values={values}
                        url={
                            action === CREATE ? createSubCategoryUrl : updateSubCategoryUrl
                        }
                    />
                )}
                {openDeleteDialog && (
                    <ConfirmationDialog
                        ...
                        dialogContentText={"Are you sure you want to delete this sub-category?"}
                    />
                )}
                <Box
                    component="main"
                    ...
                    <Container maxWidth={false}>
                        <Stack spacing={3}>
                            <Stack direction="row" justifyContent="space-between" spacing={4}>
                                <Stack spacing={1}>
                                    <Typography variant="h4">Sub-Categories Of {selected.event_category_name}</Typography>
                                </Stack>
                                <div>
                                    <Button
